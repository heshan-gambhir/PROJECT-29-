...
function setup() {
  ...
  //first level
  BlockBlue1 = new Box(220, 182, 20, 20);

  BlockBlue2 = new Box(240, 182, 20, 20);

  BlockBlue3 = new Box(260, 182, 20, 20);

  BlockBlue4 = new Box(280, 182, 20, 20);

  BlockBlue5 = new Box(300, 182, 20, 20);

  BlockBlue6 = new Box(320, 182, 20, 20);

  BlockBlue7 = new Box(340, 182, 20, 20);
